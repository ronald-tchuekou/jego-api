...
export const storeJobValidator = vine.compile(vine.object({
...
export const updateJobValidator = vine.compile(vine.object({
...
export const setExpirationValidator = vine.compile(vine.object({

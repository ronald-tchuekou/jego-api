...
export class DateRangeUtil {
    static getRelativeDate(interval, start) {
        const now = start;
        switch (interval) {
            case 'today':
            case 'day':
    ...
    static getDateRange(start, interval) {
    ...
    static getDateRangeForQuery(start, interval) {
...
//# sourceMappingURL=date_range_util.js.map